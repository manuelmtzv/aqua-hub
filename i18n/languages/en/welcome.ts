export const welcome = {
  ...
  welcomeIntroduction: `<span class="underline">Fishkeepers Hub</span> is a space to
        ...
        expert, there's always something new to
        <span class="font-bold">discover</span>.`,
  welcomeAbout: "About us",
  welcomeStart: "Get started now",

  // Features
  welcomeForumsTitle: "Discussion Forums",
  ...
  welcomeInteractionsTitle: "Interactions",
  ...
  welcomeInterestsTitle: "Follow Your Interests",
  ...
  welcomeLanguagesTitle: "Content for Everyone",
